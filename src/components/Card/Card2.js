          ...
          <div className="card h-100">
            ...
            <div className="card-body card-color">
              ...
              <div className="d-flex justify-content-center gap-2 card-position">
                <a className="btn btn-color" href="https://emrekazaz-hub.github.io/smartbrain-face-detection-full-stack/">Live Page</a>
                <a className="btn btn-color" href="https://github.com/emrekazaz-hub/smartbrain-face-detection-full-stack">Github Frontend Code</a>
                <a className="btn btn-color" href="https://github.com/emrekazaz-hub/smartbrainAPI">Github Backend Code</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card h-100">
            ...
            <div className="card-body card-color">
              ...
              <div className="d-flex justify-content-center gap-2">
                <a className="btn btn-color" href="https://emrekazaz-hub.github.io/ebank/">Live Page</a>
                <a className="btn btn-color" href="https://github.com/emrekazaz-hub/frontend-mini-banking-app">Github Code</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-body card-color">
              ...
              <div className="d-flex justify-content-center gap-2">
                <a className="btn btn-color" href="https://github.com/emrekazaz-hub/Client-Server-Chat-App">Github Code</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-body card-color">
              ...
              <div className="d-flex justify-content-center gap-2">
                <a className="btn btn-color" href="https://emrekazaz-hub.github.io/Flamingo2/">Live Page</a>
                <a className="btn btn-color" href="https://github.com/emrekazaz-hub/Flamingo2">Github Code</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-body card-color">
              ...
              <p className="card-text">
              The "StockCard" application is a Java application that allows users involved in inventory management to track their stock. Through stock cards, users can manage product information, stock quantities, and supplier details. The application provides features for creating, updating, and deleting stock cards, as well as monitoring stock levels and tracking remaining inventory.
              </p>
              <div className="d-flex justify-content-center gap-2">
                <a className="btn btn-color" href="https://github.com/emrekazaz-hub/StockCard">Github Code</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-body card-color">
              ...
              <div className="d-flex justify-content-center gap-2">
                <a className="btn btn-color" href="https://emrekazaz-hub.github.io/robo/">Live Page</a>
                <a className="btn btn-color" href="https://github.com/emrekazaz-hub/robo">Github Code</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-body card-color">
              ...
              <div className="d-flex justify-content-center gap-2">
                <a className="btn btn-color" href="https://emrekazaz-hub.github.io/protfolio/">Live Page</a>
                <a className="btn btn-color" href="https://github.com/emrekazaz-hub/protfolio">Github Code</a>
              </div>
            </div>
          </div>
        </div>
